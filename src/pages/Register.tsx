    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-foreground relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10 space-y-6">
          <h1 className="text-5xl font-bold text-primary-foreground tracking-tighter leading-[1.1]">
            Build chatbots<br />that actually work.
          </h1>
          <p className="text-primary-foreground/60 text-lg max-w-md font-medium">
            Join thousands of businesses using Botifire to automate support, boost sales, and engage customers 24/7.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div>
            <h2 className="font-display text-3xl font-bold tracking-tight text-foreground">Create an account</h2>
            <p className="text-muted-foreground font-medium mt-1.5">Get started with your free trial</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Input id="firstName" placeholder="John" className="h-11 bg-secondary/50 border-border" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="lastName" className="text-foreground text-sm font-medium">Last name</Label>
                <Input id="lastName" placeholder="Doe" className="h-11 bg-secondary/50 border-border" />
              </div>
            </div>

            <div className="space-y-2">
              <Label htmlFor="email" className="text-foreground text-sm font-medium">Email</Label>
              <Input id="email" type="email" placeholder="you@example.com" className="h-11 bg-secondary/50 border-border" />
            </div>
